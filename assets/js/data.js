...
export const QUESTIONS = [
...

  {
    ...
    desc: "用于判断是否可能进入“享惠主体”等主体前置的政策路径。",
    type: "single",
    options: [
  ...
  },
  {
    ...
    desc: "用于判断是否触发政策中的排除性条件（例如经营异常、失信等）。",
    type: "multi",
    options: [
...

  {
    ...
    desc: "用于判断更可能涉及生产加工/贸易销售/自用等不同路径解释。",
    type: "single",
    options: [
  ...
  },
  {
    ...
    desc: "用于判断系统是否能继续做“征税目录/商品范围”的精确判断。",
    type: "single",
    options: [
...

  {
    ...
    desc: "用于判断是否需要深入“享惠主体+目录外货物”的路径判断。",
    type: "single",
    options: [
...

  {
    ...
    desc: "用于判断是否可能进入“加工增值≥30%免关税”的专项路径（微小加工通常被排除）。",
    type: "single",
    options: [
  ...
  },
  {
    ...
    desc: "用于判断是否具备进入专项路径的产业前置条件（不要求你读目录）。",
    type: "single",
    options: [
